...
Here we will have an example of implementing Multiple Linear Regression Model by minimising the loss function.

Given the dataset we will follow following steps for predicting.
